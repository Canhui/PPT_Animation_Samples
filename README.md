## 1. Important
This project currently supports only Chinse version. 


## 2. PPT Animation Samples

Please see [samples](https://github.com/Canhui/PPT_Animation_Samples). The samples are self-explanatory. 
